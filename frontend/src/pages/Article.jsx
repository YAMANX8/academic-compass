...
function Article() {
  ...
  const articleData = {
    ...
    incidunt tenetur. Esse aperiam harum nulla omnis consectetur hic
    deleniti assumenda voluptate excepturi itaque corporis adipisci,
          ...
          <div>
            <div className="max-w-3xl w-full mx-auto p-[24px] bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <div className="flex justify-between items-center border-t pt-4">
                ...
                <span className="text-accent font-medium italic font-serif">{articleData.date}</span>
              </div>
            </div>
