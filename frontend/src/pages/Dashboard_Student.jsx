  ...
  const courses = [
    {
      ...
      subtitle: 'Course subtitle goes here goes here goes here goes here ......',
      progress: '60%',
      completion: '60',
      stars: 4.5,
    },
        ...
        <div className=" col-span-8">
          <DashboardWrapper heading="My Profile" optionalText={`Welcome back, ${name}`}>
            <div className="flex justify-between">
              <div>
                <img src={images.Profile} className="h-[167px] w-[167px] rounded-full" alt="Profile" />
                <p className="px-[32px] py-[18px] text-text font-poppins  font-semibold leading-[125.5%] tracking-[-0.48px]">{name}</p>
                <p className="whitespace-nowrap text-primary font-poppins text-base font-semibold leading-[125.5%] tracking-[-0.48px] px-[28px]">{position}</p>
              </div>
      ...
      <DashboardWrapper heading="In Progress Courses">
        <div className="flex overflow-x-scroll gap-8 pb-4">
          {courses.map((course, index) => (
            ...
            >
              <div>
                <img src={course.image} className="w-[336px] h-[189px]" alt="Course" />
              </div>
        ...
        <DashboardWrapper heading={'Popluar Roadmaps'}>
            <div className="grid grid-cols-2  space-x-[55px]  w-[355px] h-[60px]  bg-light rounded-[20px] items-center  flex-shrink-0 rounded-20 ">
              <span className="px-[16px] text-accent font-medium font-poppins text-20 leading-normal tracking[-0.6px]   ">Frontend</span>
              <button className=" w-[112px] h-[44px] flex justify-center  bg-gradient-to-r from-[#253AD4] to-[#6A1EAD] text-white  rounded-[5px] items-center  " >
                   View
              <ReturnLeft className="ml-[10px]  text-[20px]"/>
              </button>
            ...
            <div className="grid grid-cols-2  space-x-[55px]  w-[355px] h-[65px]  bg-light rounded-[20px] items-center  flex-shrink-0 rounded-20 ">
              <span className="px-[16px] text-accent font-medium font-poppins text-20 leading-normal tracking[-0.6px]   ">Backend</span>
              <button className=" w-[112px] h-[44px] flex justify-center  bg-gradient-to-r from-[#253AD4] to-[#6A1EAD] text-white  rounded-[5px] items-center  " >
                   View
              <ReturnLeft className="ml-[10px]  text-[20px]"/>
              </button>
            ...
            <div className="grid grid-cols-2  space-x-[55px]  w-[355px] h-[65px] bg-light rounded-[20px] items-center  flex-shrink-0 rounded-20 ">
              <span className="px-[16px] whitespace-nowrap text-accent font-medium font-poppins text-20 leading-normal tracking[-0.6px]   ">Artificial Intelligence</span>
              <button className=" w-[112px] h-[44px] flex justify-center  bg-gradient-to-r from-[#253AD4] to-[#6A1EAD] text-white  rounded-[5px] items-center  " >
                   View
              <ReturnLeft className="ml-[10px]  text-[20px]"/>
              </button>
